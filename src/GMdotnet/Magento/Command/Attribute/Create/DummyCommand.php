...
namespace GMdotnet\Magento\Command\Attribute\Create;
...
class DummyCommand extends \N98\Magento\Command\AbstractMagentoCommand
{
    ...
    var $designer = array(
        ...
        'Aperlai',
        'Apiece Apart',
        'April Chrichton & Nicholas Party',
        'Aquazzura',
        ...
        'Isabel Marant For Oliver Peoples',
        'Isolda',
        'Issey Miyake',
        ...
        'Junya Watanabe Comme Des Garçons Vintage',
        'Just Cavalli',
        'Just Female',
        'Jvdf',
        'K. Jacques',
        ...
        'Liska',
        'Liska Haute Fourrure By Romain Brau',
        'Live The Process With Chelsea Leyland',
        'Living Proof',
        ...
        'Pleats Please By Issey Miyake Vintage',
        'Plein Sud',
        'Pollini',
        'Polo Ralph Lauren',
        'Pomellato',
        ...
        'Samantha Sung',
        'Samira13',
        'Samsung By Colombo Via Della Spiga',
        'San Lorenzo',
        'Sandrine Rose',
        'Sandy Liang',
        'Santoni',
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('(Experimental) Create a dummy values for attributes [gmdotnet]')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->output->writeln("<warning>This is experimental and it only create sample attribute values.</warning>\r\n");
        ...
        for($i = 0; $i < $_argument['values-number']; $i++) {
            ...
            $value = $this->createValue($_argument['values-type']);
     ...
     * @return int|string
     */
    protected function createValue($_type)
    {
        switch($_type)
        {
            case 'int':
            ...
            case 'string':
                ...
                break;
            case 'color':
                $value = $this->colors[array_rand($this->colors)];
                break;
            case 'size':
